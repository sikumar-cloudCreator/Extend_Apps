...
def generate_query(request: str, tables=None, needed_columns=None, params=None,
    ...
    schema = schema or os.environ.get("EXTEND_DEFAULT_SCHEMA", "$framework")
...
if __name__ == "__main__":
    ...
    ap.add_argument("--schema", default=None, help="datasource schema (default: $EXTEND_DEFAULT_SCHEMA or '$framework')")
